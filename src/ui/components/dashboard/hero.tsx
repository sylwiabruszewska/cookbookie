...
const HeroSection = () => {
  return (
    <div className="h-[90vh] md:min-h-[500px] md:h-[50%] lg:h-[90vh] py-12 md:py-8 lg:px-14 ">
      ...
      <div className="flex flex-col md:flex-row gap-14 md:gap-8 lg:gap-20 justify-between items-center">
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start">
          ...
          <p className="md:text-base lg:text-xl text-center md:text-left mb-12 lg:mb-20">
